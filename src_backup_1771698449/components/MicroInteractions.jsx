...
export const CustomCursor = () => {
    ...
    useEffect(() => {
        ...
        if (cursorState === 'hover') {
            gsap.to(ring, { width: 60, height: 60, borderColor: 'rgba(249,115,22,1)', opacity: 1, duration: 0.35, ease: 'power3.out' });
            gsap.to(dotRef.current, { scale: 0.4, background: 'rgba(249,115,22,1)', duration: 0.25 });
            gsap.to(label, { opacity: 1, scale: 1, duration: 0.3, ease: 'back.out(1.7)' });
        } else {
            gsap.to(ring, { width: 36, height: 36, borderRadius: 50, borderColor: 'rgba(249,115,22,0.6)', opacity: 0.8, duration: 0.35, ease: 'power3.out' });
    ...
    return (
        <div className="hidden md:block pointer-events-none">
            ...
            <div
                ref={auraRef}
                className="fixed top-0 left-0 w-[60px] h-[60px] bg-accent/25 rounded-full blur-xl pointer-events-none z-[9990] -translate-x-1/2 -translate-y-1/2 transform-gpu mix-blend-screen will-change-transform"
            />
            ...
            <div
                ...
                style={{ width: 36, height: 36, borderRadius: '50%', border: '1.5px solid rgba(249,115,22,0.6)', opacity: 0.8 }}
            >
            ...
            <div
                ref={dotRef}
                className="fixed top-0 left-0 w-[7px] h-[7px] pointer-events-none z-[9997] -translate-x-1/2 -translate-y-1/2 rounded-full will-change-transform transform-gpu"
