...
const Philosophy = () => {
    ...
    return (
        <section ref={containerRef} className="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center z-20">
            {/* Massive Background Text for Depth */}
            <h2
                ref={bgRef}
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15rem] md:text-[30rem] font-display font-bold text-white/[0.02] whitespace-nowrap pointer-events-none tracking-tighter"
            >
                THE STANDARD
            </h2>
